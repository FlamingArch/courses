...
struct ContentView: View {
    ...
    @FetchRequest(sortDescriptors: [], predicate: nil) var countries: FetchedResults<Country>
...
//    // @FetchRequest(sortDescriptors: [], predicate: NSPredicate(format: "NOT name BEGINSWITH[c] %@", "e")) var ships: FetchedResults<Ship> // Case Insensitive
//
//    var body: some View {
//        VStack {
