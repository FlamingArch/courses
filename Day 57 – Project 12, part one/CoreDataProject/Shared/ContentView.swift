...
//    // @FetchRequest(entity: Ship.entity(), sortDescriptors: [], predicate: NSPredicate(format: "name BEGINSWITH[c] %@", "e")) var ships: FetchedResults<Ship> // CASE INSENSITIVE
//    // @FetchRequest(entity: Ship.entity(), sortDescriptors: [], predicate: NSPredicate(format: "name CONTAINS %@", "E")) var ships: FetchedResults<Ship> // CASE SENSITIVE
//    // @FetchRequest(entity: Ship.entity(), sortDescriptors: [], predicate: NSPredicate(format: "NOT name CONTAINS %@", "E")) var ships: FetchedResults<Ship> // CASE SENSITIVE
//
//    var body: some View {
//        VStack {
